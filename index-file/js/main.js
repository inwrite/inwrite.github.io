...
const messages = {
  contact: [
    ...
    // другие сообщения...
    // "Это рандомное изображение\n\n<div class='randomimg'><img class='randomsvg' src='ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>"
  ],
  ukrain: [
    "My position is as follows: I categorically condemn the actions of the current Russian government, which, in my opinion, is based on aggression, lies, and deceit. I consider this government illegitimate, as power was transferred from one ruler to another under the guise of pseudo-democratic elections. Although the elections formally appeared to be a democratic process, in reality, all resources and mechanisms of governance were used to shape public opinion through strict censorship, propaganda, and the suppression of opposition.<div class='randomimg'><img class='randomsvg' src='index-file/ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>The events of February 22, when Russia once again invaded Ukrainian territory, clearly demonstrated that power is maintained through manipulation and intimidation. The authorities suppress any independent perspective, conceal information about repression and crimes, labeling these truths as lies and branding them as 'fake news.' Independent media face severe pressure and are declared foreign agents, keeping the public in the dark. This reveals that the Russian government, fearing a loss of control, uses repression and creates artificial threats to unite the people around itself, depriving society of the opportunity for honest choice and truthful information.\n\nAn example of this brutality can be seen in an <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=en&img_index=8' target='_blank'>Instagram link,</a> which shows one of the attacks carried out by Russian forces on Ukrainian territory. Such attacks harm civilians, including women and children, and destroy critical infrastructure like hospitals. In Russia, these facts are labeled as lies, and people who try to share the truth face criminal prosecution and severe punishment.",
    
    "My stance is this: I firmly condemn the actions of the current Russian government, which operates through aggression, lies, and disinformation. I consider this government illegitimate because power has been transferred between rulers under the guise of elections that were, in reality, mere formalities. The entire state apparatus has used propaganda, strict censorship, and the suppression of the opposition to create a manipulated opinion in society.<div class='randomimg'><img class='randomsvg' src='index-file/ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>The events of February 22, when Russia again invaded Ukraine, confirmed the use of intimidation and manipulation to stay in power. The government destroys any independent sources of information, declaring the truth to be 'fake news,' while independent media are subjected to persecution and repression. This regime is built on fear and artificially created threats to control public consciousness and prevent honest criticism.\n\nAn example of how these crimes are concealed can be found in an <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=en&img_index=8' target='_blank'>Instagram link,</a> where one of the Russian attacks on civilian targets in Ukraine is documented. These attacks destroy hospitals, schools, and vital infrastructure, causing immense suffering for civilians, including women and children. In Russia, these truths are meticulously suppressed, and those who try to spread them face severe persecution and imprisonment.",
    
    "My position is clear: I unequivocally condemn the actions of the current Russian government, which bases its policies on aggression, deceit, and the suppression of free speech. Power in the country has been transferred from one ruler to another through sham elections that only created the illusion of democracy. The actual process involved manipulation and strict information control, preventing people from genuinely expressing their views.<div class='randomimg'><img class='randomsvg' src='index-file/ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>The events of February 22, when Russia launched a new wave of invasion into Ukraine, became a vivid example of the use of intimidation to maintain power. The government suppresses dissent and labels the truth as 'fake news,' prosecuting those who try to convey it to the public. Instead of dialogue, propaganda and artificial threats are used to distract the people and maintain governmental control.\n\nAn example of one such attack can be found in this <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=en&img_index=8' target='_blank'>Instagram link,</a> which shows how Russian forces destroy civilian infrastructure. The victims are innocent people, including children and women. In Russia, these facts are declared falsehoods, and those spreading the truth are harshly persecuted."
  ],
  tempmail: ["<div class='inMail'></div>"],
  personal: [
    "<div class='ava'><img src='index-file/IMG_0881.png' alt='Mikhail'></div><strong>I am a web developer specializing in supporting small and medium-sized businesses in achieving success online.</strong> My mission is to help companies increase their visibility on the web and strengthen customer relationships through effective and reliable web solutions.\n\nIn addition to client work, I am the founder and visionary behind several personal projects:\n<ul><li><a href='https://inwrite.org/' target='_blank'>inWrite</a> — a convenient platform for anonymous online publishing, allowing you to share thoughts and ideas without registration.</li><li><a href='https://inwrite.org/chat/' target='_blank'>inChat</a> — a secure anonymous messenger for online communication and message exchange.</li><li><a href='https://inwrite.github.io/inMail/' target='_blank'>inMail</a> — a service providing temporary email addresses for anonymous and secure receipt of emails.</li><li><a href='https://wopr.ru/' target='_blank'>WoPr</a> — a platform offering free creation and hosting of websites of any complexity on the WordPress CMS.</li><li><a href='https://wikli.ru/' target='_blank'>Wikli</a> — a platform that allows free creation and hosting of websites using WordPress CMS(2025).</li><li><a href='https://usink.ru/' target='_blank'>UsInk</a> — a service for creating and hosting simple business card websites, suitable for personal and professional purposes.</li><li><a href='https://inwrite.github.io/protest/' target='_blank'>Protest</a> — a collection of my artwork and covers in SVG format, available under the Creative Commons Zero (CC0) license.</li></ul>For those interested in my early projects, <a href='https://inwrite.github.io/xiv/' target='_blank'>my old portfolio</a> is also available for review.\n\nI am always open to new challenges and strive to find innovative solutions that help businesses grow and adapt to modern demands.",

    "<div class='ava'><img src='index-file/IMG_0881.png' alt='Mikhail'></div><strong>I am a web developer helping small and medium-sized businesses achieve success online.</strong> My main goal is to enhance brand visibility and build strong relationships with customers through high-quality and modern web products.\n\nI am also the founder and visionary behind several exciting projects:\n<ul><li><a href='https://inwrite.org/' target='_blank'>inWrite</a> — an online platform for anonymous publishing, providing a way to share content without mandatory registration.</li><li><a href='https://inwrite.org/chat/' target='_blank'>inChat</a> — a secure space for anonymous communication and message exchange online.</li><li><a href='https://inwrite.github.io/inMail/' target='_blank'>inMail</a> — a service for creating temporary email addresses, ensuring protection and privacy.</li><li><a href='https://wopr.ru/' target='_blank'>WoPr</a> — a system for free website creation and management using WordPress CMS.</li><li><a href='https://wikli.ru/' target='_blank'>Wikli</a> — a platform that allows free creation and hosting of websites using WordPress CMS(2025).</li><li><a href='https://usink.ru/' target='_blank'>UsInk</a> — a fast platform for creating simple and convenient business card websites.</li><li><a href='https://inwrite.github.io/protest/' target='_blank'>Protest</a> — a unique collection of SVG artwork available for free use under the Creative Commons Zero (CC0) license.</li></ul>To explore my early projects, you can check out <a href='https://inwrite.github.io/xiv/' target='_blank'>my old portfolio</a>, which I no longer maintain.\n\nI am always eager for new projects and strive to find unique solutions that drive business growth and development.",

    "<div class='ava'><img src='index-file/IMG_0881.png' alt='Mikhail'></div><strong>I am a web developer who helps small and medium-sized businesses thrive in the digital space.</strong> My goal is to increase companies' online presence and improve customer engagement through innovative web solutions.\n\nIn addition to client projects, I develop and support my own initiatives:\n<ul><li><a href='https://inwrite.org/' target='_blank'>inWrite</a> — a service for anonymous publishing, making it easy to share thoughts online without registration.</li><li><a href='https://inwrite.org/chat/' target='_blank'>inChat</a> — a secure platform for anonymous communication and information exchange.</li><li><a href='https://inwrite.github.io/inMail/' target='_blank'>inMail</a> — a service for temporary email addresses, allowing for the secure receipt of emails.</li><li><a href='https://wopr.ru/' target='_blank'>WoPr</a> — a platform for free website creation and hosting using the WordPress CMS.</li><li><a href='https://wikli.ru/' target='_blank'>Wikli</a> — a platform that allows free creation and hosting of websites using WordPress CMS(2025).</li><li><a href='https://usink.ru/' target='_blank'>UsInk</a> — a service for quickly creating business card websites, ideal for both business and personal needs.</li><li><a href='https://inwrite.github.io/protest/' target='_blank'>Protest</a> — a collection of unique SVG artwork available under the Creative Commons Zero (CC0) license.</li></ul>My <a href='https://inwrite.github.io/xiv/' target='_blank'>old portfolio</a> is available for those who want to learn more about my early projects.\n\nI am always looking for new opportunities to create web solutions that help businesses adapt and flourish in a rapidly changing market.",

    "<div class='ava'><img src='index-file/IMG_0881.png' alt='Mikhail'></div><strong>As a web developer, I help small and medium-sized businesses succeed online.</strong> My goal is to make companies stand out from the competition and build long-lasting customer relationships through modern web tools.\n\nI am also the creator and leader of several personal projects:\n<ul><li><a href='https://inwrite.org/' target='_blank'>inWrite</a> — an online platform for simple anonymous publishing, allowing you to share content without registration.</li><li><a href='https://inwrite.org/chat/' target='_blank'>inChat</a> — a secure messenger for anonymous communication online.</li><li><a href='https://inwrite.github.io/inMail/' target='_blank'>inMail</a> — a service for temporary email addresses, enabling anonymous and secure receipt of emails.</li><li><a href='https://wopr.ru/' target='_blank'>WoPr</a> — a platform that allows free creation and hosting of websites using WordPress CMS.</li><li><a href='https://wikli.ru/' target='_blank'>Wikli</a> — a platform that allows free creation and hosting of websites using WordPress CMS(2025).</li><li><a href='https://usink.ru/' target='_blank'>UsInk</a> — a convenient tool for creating simple business card websites, suitable for various purposes.</li><li><a href='https://inwrite.github.io/protest/' target='_blank'>Protest</a> — a collection of SVG artwork available for free use under the Creative Commons Zero (CC0) license.</li></ul>If you are interested in my early work, feel free to check out <a href='https://inwrite.github.io/xiv/' target='_blank'>my old portfolio</a>, which, although no longer updated, can still be of interest.\n\nI am constantly striving to create solutions that help businesses adapt to new conditions and achieve their goals in the digital space.",
  ],
  unknown: [

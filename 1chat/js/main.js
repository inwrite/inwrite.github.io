...
const messages = {
  ...
  ukrain: [
    "Моя позиция заключается в следующем: я категорически осуждаю действия нынешнего российского правительства, которое, по моему мнению, основывается на агрессии, лжи и обмане. Я считаю эту власть нелегитимной, поскольку она была передана от одного правителя к другому под прикрытием псевдодемократических выборов. Хотя формально выборы выглядели как демократический процесс, на самом деле все ресурсы и рычаги управления использовались для формирования нужного мнения в обществе через жесткую цензуру, пропаганду и подавление оппозиции.<div class='randomimg'><img class='randomsvg' src='ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>События 22 февраля, когда Россия вновь вторглась на территорию Украины, ясно показали, что для удержания власти используются манипуляции и запугивание. Власть подавляет любую независимую точку зрения, скрывает информацию о репрессиях и преступлениях, называя эти факты ложью и объявляя правду “фейками”. Независимые СМИ подвергаются давлению и объявляются иностранными агентами, чтобы общество оставалось в неведении. Все это демонстрирует, что российская власть, боясь потерять контроль, применяет репрессии и создает искусственные угрозы, чтобы сплотить народ вокруг себя, лишая общество возможности честного выбора и правдивой информации.\n\nПример этой жестокости можно увидеть по <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=ru&img_index=8' target='_blank'>ссылке в Instagram,</a> где показано одно из нападений, совершенных российскими силами на территории Украины. В результате таких атак страдают мирные жители, включая женщин и детей, а гражданские объекты, такие как больницы и инфраструктура, подвергаются разрушению. В России эти факты объявляются ложью, а люди, пытающиеся донести правду, подвергаются уголовным преследованиям и жестоким наказаниям.",
    "Моя позиция заключается в следующем: я категорически осуждаю действия нынешнего российского правительства, которое действует через агрессию, ложь и дезинформацию. Я считаю эту власть нелегитимной, так как передача власти между правителями происходила под видом выборов, которые на самом деле были лишь формальностью. Вся государственная система использовала пропаганду, жесткую цензуру и подавление оппозиции, чтобы создать нужное мнение в обществе.<div class='randomimg'><img class='randomsvg' src='ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>События 22 февраля, когда Россия вновь вторглась на территорию Украины, подтвердили использование запугивания и манипуляций для удержания власти. Правительство уничтожает любые независимые источники информации, объявляя правду “фейками”, а независимые СМИ подвергаются преследованиям и репрессиям. Этот режим построен на страхе и искусственно созданных угрозах, чтобы контролировать общественное сознание и не допустить честной критики.\n\nПример того, как скрываются эти преступления, можно увидеть по <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=ru&img_index=8' target='_blank'>ссылке в Instagram,</a> где демонстрируется одно из нападений российских сил на украинские гражданские объекты. Подобные атаки разрушают больницы, школы и важную инфраструктуру, приводя к страданиям мирных жителей, включая женщин и детей. В России такие факты старательно замалчиваются, а тех, кто пытается донести правду, преследуют и лишают свободы.",
    "Моя позиция следующая: я однозначно осуждаю действия нынешнего российского правительства, которое основывает свою политику на агрессии, обмане и подавлении свободы слова. Власть в стране была передана от одного правителя к другому в рамках псевдовыборов, которые лишь создавали видимость демократии. Реальный процесс состоял в манипуляциях и строгом контроле над информацией, чтобы не допустить честного выражения мнения народа.<div class='randomimg'><img class='randomsvg' src='ukr/stop_putin_stop_war.svg' alt='Random SVG'><button id='loadImageButton'><svg width='24' height='24'><use xlink:href='#icon-refresh'></use></svg>Refresh image</button></div>События 22 февраля, когда Россия начала новую волну вторжения в Украину, стали ярким примером применения запугивания для удержания власти. Власть подавляет инакомыслие и называет правдивую информацию “фейками”, преследуя тех, кто пытается донести правду до общественности. Вместо диалога используются пропаганда и искусственные угрозы, чтобы отвлечь народ и поддержать контроль правительства.\n\nПример одной из таких атак можно найти по <a href='https://www.instagram.com/p/C9KAuhJo4VF/?hl=ru&img_index=8' target='_blank'>ссылке в Instagram,</a> где показано, как российские силы разрушают гражданские объекты. Пострадавшими становятся мирные жители, включая детей и женщин, но в России эти факты объявляют ложью, а распространяющих правду жестоко преследуют.",
